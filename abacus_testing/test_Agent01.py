...
try:
    ...
    try:
        ...
        AGENT01_FUNCTIONS_AVAILABLE = True
        print("✅ Imported from Agent01.functions")
    except ImportError:
        AGENT01_FUNCTIONS_AVAILABLE = False
        print("⚠️ Agent01/Agent01.functions not available")
...
class TestFunctions:
    ...
    def test_call_openai_success(self, mock_client, mock_openai_response):
        ...
        try:
            ...
            # If patch doesn't work with Agent01, try Agent01
            with patch('Agent01.functions.client') as mock_client_alt:
